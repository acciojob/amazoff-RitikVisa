...
public class OrderController {
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam("oid") String orderId, @RequestParam("pid") String partnerId){
        ...
        service.add_order_partner(partnerId,orderId);
    ...
    public ResponseEntity<Order> getOrderById(@PathVariable String orderId){
        ...
        Order order = service.get_order_by_id(orderId);
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        //orderCount should de  note the orders given by a partner-id
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
       int LastTime = service.getLastDeliveryTimeByPartnerId(partnerId);
        int hh = LastTime/60;
        int mm = LastTime%60;
        String s= String.valueOf(hh);
        String ss= String.valueOf(mm);
